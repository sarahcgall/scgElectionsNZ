...
A detailed explanation of the allocation process can be found in the [`Summary`]() article. For electorate-level Party Vote data, view the [`party_votes`](https://sarahcgall.github.io/scgElectionsNZ/reference/party_votes.html) dataset.
<br>
<br>

#### Candidate Vote
The FPTP results can be accessed through the [`candidate_votes`](https://sarahcgall.github.io/scgElectionsNZ/reference/candidate_votes.html) dataset at the electorate-level (NB. the `candidate_votes` dataset only contains successful parties only with unsuccessful parties being grouped as 'Other'). The type of electorate (M&#257;ori or General) can also be identified using the [`add_type`](https://sarahcgall.github.io/scgElectionsNZ/reference/add_type.html) function.
